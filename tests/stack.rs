...
type DstStack<T> = stack_dst::Stack<T, ::stack_dst::buffers::Ptr8>;
...
#[test]
fn limits() {
    let mut val = stack_dst::Stack::<dyn Any, ::stack_dst::buffers::Ptr2>::new();
    // Pushing when full
...
fn destructors() {
    ...
    let mut stack = ::stack_dst::Stack::<dyn Any, ::stack_dst::buffers::Ptr8>::new();
...
fn slice_push_panic_safety() {
    ...
    let _ = ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(|| {
        let mut stack = ::stack_dst::Stack::<[Sentinel], ::stack_dst::buffers::Ptr8>::new();
